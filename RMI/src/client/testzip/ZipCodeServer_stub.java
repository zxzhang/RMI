...
public class ZipCodeServer_stub extends Stub implements ZipCodeServer {
  ...
  public void initialise(ZipCodeList newlist) {
    ...
    Message m = new Message(Util.MessageType.Client2Server, ror, "initialise", args, argsType,
            returnType);
    try {
      // Message ret =
      connect(m);
  ...
  public String find(String city) {
    ...
    Message m = new Message(Util.MessageType.Client2Server, ror, "find", args, argsType, returnType);
  ...
  public ZipCodeList findAll() {
    ...
    Message m = new Message(Util.MessageType.Client2Server, ror, "findAll", args, argsType,
            returnType);
    try {
      Message ret = connect(m);
  ...
  public void printAll() {
    ...
    String[] argsType = new String[] {};
    String returnType = "void"; // "void";
    Message m = new Message(Util.MessageType.Client2Server, ror, "printAll", args, argsType,
            returnType);
    try {
      // Message ret =
      connect(m);
